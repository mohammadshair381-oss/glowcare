...
from .views_dashboard import (
  ...
  ProductGalleryUploadView,
  ProductGalleryRemoveView,
  ProductGalleryOrderView,
  BrandsView,
  SubCategoriesView,
  FeaturedLogosView,
...
urlpatterns = [
  ...
  path("products/brands/", BrandsView.as_view(), name="brands_manage"),
  path("products/subcategories/", SubCategoriesView.as_view(), name="subcategories_manage"),
  ...
  path("products/<int:pk>/gallery/upload/", ProductGalleryUploadView.as_view(), name="product_gallery_upload"),
  path("products/<int:pk>/gallery/remove/", ProductGalleryRemoveView.as_view(), name="product_gallery_remove"),
  path("products/<int:pk>/gallery/order/", ProductGalleryOrderView.as_view(), name="product_gallery_order"),
